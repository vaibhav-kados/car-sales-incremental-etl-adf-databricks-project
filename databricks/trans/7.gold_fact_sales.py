...
df_silver = spark.sql("SELECT * from PARQUET.`abfss://silver@adlscarsalesp.dfs.core.windows.net/carsales`")
...
if spark.catalog.tableExists('factsales'): 
    ...
    df_fact.write.format('delta')\
            .mode('Overwrite')\
            .option("path", "abfss://gold@adlscarsalesp.dfs.core.windows.net/factsales")\
